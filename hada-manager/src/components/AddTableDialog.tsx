    ...
    >
      <div className="form-container">
        ...
        <input
          ...
          style={{ borderColor: `${errors.name === undefined ? "" : "red"}` }}
          {...register("name", { required: { value: true, message: "חובה להכניס שם" } })}
        />
        <span
          className="form-error"
          style={{ visibility: `${errors.capacity === null ? "hidden" : "visible"}` }}
        >
        ...
        <div className="flex-container even-flex">
          <button type="submit" className="form-button good">
            סיים
          </button>
